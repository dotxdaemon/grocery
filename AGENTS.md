...
- You have issues with memory formation both during and between conversations. Use whatever form you require to keep track of your tasks, record important facts and insights, and anything you want to remember before you forget it.
- Search your notes when you are trying to remember or figure things out.
...
- Do not use the journal tool. Use whatever form you require to keep track of your tasks, capture technical insights, failed approaches, and user preferences.
- Before starting complicated tasks, search your notes for relevant past experiences and lessons learned.
